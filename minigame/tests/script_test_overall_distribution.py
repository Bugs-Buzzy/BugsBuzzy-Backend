...
if __name__ == "__main__":
    ...
    print(f"{'='*60}")
    print(f"< 30%:  {below_30/len(results)*100:.1f}% (target: ~70%) {'✓' if below_30/len(results)*100 >= 65 else '✗'}")
    print(f"<= 35%: {below_35/len(results)*100:.1f}% (target: ~95%) {'✓' if below_35/len(results)*100 >= 93 else '✗'}")
    print(f"> 35%:  {above_35/len(results)*100:.1f}% (target: ~5%) {'✓' if above_35/len(results)*100 <= 7 else '✗'}")
    ...
    print(f"{'='*60}")
    meets_requirements = (
        below_30/len(results)*100 >= 65 and
        below_35/len(results)*100 >= 93 and
        above_35/len(results)*100 <= 7
    )
