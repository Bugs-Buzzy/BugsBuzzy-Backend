...
from .views import MyTeamView, TeamCreateView, TeamJoinView, TeamLeaveView, TeamUpdateView, TeamActivateView, CompetitionStatusView, SubmissionCreateView, SubmissionListView
