...
urlpatterns = [
    ...
    path(
        "in-person/<int:team_id>/leave/",
        views.InPersonTeamLeaveView.as_view(),
        name="in-person-team-leave",
    ),
    ...
    path(
        "online/<int:team_id>/leave/", views.OnlineTeamLeaveView.as_view(), name="online-team-leave"
    ),
    # Team details
    path(
        "in-person/<int:pk>/", views.InPersonTeamDetailView.as_view(), name="in-person-team-detail"
    ),
    path("online/<int:pk>/", views.OnlineTeamDetailView.as_view(), name="online-team-detail"),
    # Team members
    path(
        "in-person/<int:team_id>/members/",
        views.InPersonTeamMembersView.as_view(),
        name="in-person-team-members",
    ),
    path(
        "online/<int:team_id>/members/",
        views.OnlineTeamMembersView.as_view(),
        name="online-team-members",
    ),
]
