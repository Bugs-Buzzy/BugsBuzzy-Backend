...
class InPersonTeamAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Team Information", {"fields": ("name", "description", "status", "invite_code")}),
        ("Leader Information", {"fields": ("leader",)}),
...
class TeamMemberAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Member Information", {"fields": ("user", "in_person_team", "online_team")}),
        ("System Information", {"fields": ("joined_at",), "classes": ("collapse",)}),
    )
